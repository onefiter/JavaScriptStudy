...
/**
 * Created by onefiter on 2016/10/26.
 */
window.onload = function ()
{
    var oTable = document.getElementById('taobao_table');
    var oBtnSelectAll = oTable.getElementsByTagName('input')[0];//取得input标签的第一个元素,此时为全选按钮
    var aInputs=oTable.getElementsByTagName('input');//数组
    var oRows = oTable.tBodies[0].rows; //一个集合
